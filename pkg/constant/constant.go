...
var FileName = map[string]string{
	...
	"获取用户token信息":   "getUserToken",
	"查询用户是否注册":      "checkUserRegistered",
	"已注册用户列表":       "getRegisteredUserList",
	"获取所有用户ID":      "getAllUserID",
	...
	"获取指定好友双向申请列表":     "getFriendApplicationList",
	"获取指定好友信息":         "getFriendInfo",
	"订阅或取消订阅一批用户的在线状态": "subscribeUsersStatus",
	...
	"设置群组信息":        "setGroupInfo",
	"获取群的加群申请":      "getRecvGroupApplicationList",
	"处理进群申请":        "groupApplicationResponse",
	"获取自己的主动加群申请":   "getUserReqGroupApplicationList",
	"获取该群指定用户的加群申请": "getGroupApplicationListByUserID",
