...
//
// }
func generateOnePageMarkDown(jsonStr string, globalHeader []pkg.Header, bigTile string, catalogPath string, x bool, pageNumber int32) {
	...
	sb.WriteString("---\nsidebar_position: " + strconv.Itoa(int(pageNumber)) + "\ntitle: " + bigTile + "\nhide_title: true\n---\n")
